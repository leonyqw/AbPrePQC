#!/usr/bin/env python
"""
MultiQC_AbPreP is a plugin for MultiQC, providing additional tools which are
specific to antibody long-read preprocessing.
...
#     install_requires=["ibmcloudant>=0.9.1", "simplejson", "pyyaml", "requests", "multiqc>=1.22.dev0"],
#     entry_points={
